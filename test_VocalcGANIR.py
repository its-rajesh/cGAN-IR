...
model = tf.keras.models.load_model('/home/anchal/Desktop/rajesh/Clean/cGAN_IR/IndependentModels/models/generator_epoch_900.h5')
...
path1 = "/home/anchal/Desktop/rajesh/Clean/cGAN_IR/IndependentModels/XvocalCM3.npy"
path2 = "/home/anchal/Desktop/rajesh/Clean/cGAN_IR/IndependentModels/YvocalCM3.npy"
...
outpath = "/home/anchal/Desktop/rajesh/Clean/cGAN_IR/IndependentModels/Outputs/"
k = 3000
fs = 22050
...
true_db = librosa.db_to_amplitude(np.squeeze(Ytrain[k:k+1,:,:]))
true = librosa.griffinlim(true_db)
sf.write(outpath+'tvocals.wav',true,fs)

plt.figure(figsize=(10, 6))
librosa.display.specshow(true_db, sr=fs, x_axis='time', y_axis='log')
plt.colorbar(format='%+2.0f dB')
plt.title('True Spectrogram')
plt.show()
plt.savefig(outpath+'true.png')
